...
--
-- Host: localhost:3306
-- Generation Time: Oct 15, 2018 at 09:34 AM
...
(122, 'cat', 'Tiger', 'M', 2009, 'JoshS', 101),
(123, 'parrot', 'Harmony', 'F', 2013, 'JoshS', 102),
(124, 'dog', 'Marley', 'M', 2009, 'JoshS', 103),
(125, 'goldfish', 'Florence', 'M', 2018, 'JoshS', 104),
(126, 'pig', 'Polly', 'F', 2017, 'JoshS', 105),
(127, 'dog', 'Happy', 'F', 2018, 'JoshS', 101),
(128, 'hamster', 'Mr. Bean', 'M', 2018, 'JoshS', 106),
(129, 'cat', 'Mary', 'F', 2010, 'JoshS', 107),
(130, 'tortoise', 'Nitro', 'M', 2005, 'JoshS', 108),
(131, 'rabbit', 'Sarah', 'F', 2016, 'JoshS', 109),
(132, 'dog', 'Moxy', 'F', 2010, 'JoshS', 104),
(133, 'horse', 'Lily', 'F', 2009, 'JoshS', 105),
(134, 'iguana', 'Larry', 'M', 2012, 'JoshS', 107),
(135, 'parakeet', 'Kiwi', 'F', 2015, 'JoshS', 110),
(136, 'lizard', 'Joe', 'M', 2011, 'JoshS', 102),
(137, 'Dog', 'Felix', 'M', 2014, 'Justin F', 111),
(138, 'Cat', 'Mars', 'M', 2012, 'Justin F', 112),
(139, 'Fish', 'Goldy', 'F', 2016, 'Justin F', 113),
(140, 'Turtle', 'Tera', 'F', 2008, 'Justin F', 114),
(141, 'Dog', 'Spark', 'M', 2013, 'Justin F', 115),
(142, 'Cat', 'Debbie', 'F', 2011, 'Justin F', 116),
(143, 'Fish', 'Bubbles', 'M', 2015, 'Justin F', 117),
(144, 'Horse', 'Rex', 'M', 2010, 'Justin F', 118),
(145, 'Rabbit', 'Snow', 'F', 2014, 'Justin F', 119),
(146, 'Turtle', 'Tom', 'M', 2008, 'Justin F', 120),
(147, 'Horse', 'Daisy', 'F', 2006, 'Justin F', 111),
(148, 'Fish', 'Joe', 'M', 2015, 'Justin F', 112),
(149, 'Cat', 'Garfield', 'M', 2012, 'Justin F', 113),
(150, 'Rabbit', 'Peter', 'M', 2011, 'Justin F', 114),
(151, 'Fish', 'Max', 'M', 2017, 'Justin F', 115),
(152, 'cat', 'JoJo', 'm', 2004, 'MichaelC', 123),
(153, 'dog', 'Monkey', 'f', 2008, 'MichaelC', 125),
(154, 'parrot', 'Polly', 'm', 2012, 'MichaelC', 121),
(155, 'dog', 'BoBo', 'm', 2016, 'MichaelC', 122),
(156, 'cat', 'Larry', 'm', 2012, 'MichaelC', 123),
(157, 'dog', 'Bailey', 'f', 2018, 'MichaelC', 129),
(158, 'dog', 'Fido', 'm', 2011, 'MichaelC', 129),
(159, 'dog', 'Cat', 'm', 2017, 'MichaelC', 127),
(160, 'cat', 'Boots', 'f', 2014, 'MichaelC', 123),
(161, 'dog', 'Benjamin', 'm', 2008, 'MichaelC', 128),
(162, 'horse', 'Speed', 'f', 2015, 'MichaelC', 130),
(163, 'dog', 'Vladimir', 'm', 2006, 'MichaelC', 126),
(164, 'lizard', 'Stephen', 'm', 2017, 'MichaelC', 129),
(165, 'cat', 'Suzy', 'f', 2015, 'MichaelC', 124),
(166, 'cat', 'Suzane', 'f', 2015, 'MichaelC', 124),
(167, 'Dog', 'Puppers', 'F', 2013, 'Perry K', 131),
(168, 'Cat', 'Kitty', 'F', 2010, 'Perry K', 131),
(169, 'Bird', 'Snuffles', 'M', 2003, 'Perry K', 132),
(170, 'Dog', 'Ruffers', 'M', 2015, 'Perry K', 133),
(171, 'Ginuea Pig', 'Des', 'M', 2014, 'Perry K', 133),
(172, 'Frog', 'Lesion', 'F', 2018, 'Perry K', 134),
(173, 'Goldfish', 'Bubbles', 'F', 2014, 'Perry K', 135),
(174, 'Pufferfish', 'Bloat', 'M', 2010, 'Perry K', 135),
(175, 'Hummingbird', 'Biz', 'M', 2014, 'Perry K', 136),
(176, 'Bunny', 'Thumper', 'F', 2009, 'Perry K', 137),
(177, 'Tucan', 'Hydre', 'F', 2009, 'Perry K', 138),
(178, 'Cow', 'Moon Moon', 'M', 1999, 'Perry K', 139),
(179, 'Wolf', 'Chan', 'F', 2005, 'Perry K', 139),
(180, 'Ant', 'Smally', 'M', 2018, 'Perry K', 140),
(181, 'Goldfish', 'Blue', 'M', 2016, 'Perry K', 137),
(182, 'dog', 'Cache', 'M', 1901, 'tannerh', 141),
(183, 'cat', 'Larry', 'M', 1902, 'tannerh', 142),
(184, 'Chicken', 'Harry', 'F', 1965, 'tannerh', 143),
(185, 'Goat', 'Billy', 'M', 1960, 'tannerh', 144),
(186, 'Horse', 'Thor', 'M', 2001, 'tannerh', 145),
(187, 'Cow', 'Jimmy', 'M', 1987, 'tannerh', 146),
(188, 'fish', 'Toby', 'M', 2005, 'tannerh', 147),
(189, 'Bird', 'Goldy', 'M', 2016, 'tannerh', 148),
(190, 'Rabbit', 'Flake', 'M', 2018, 'tannerh', 149),
(191, 'Turtle', 'Billy', 'M', 1954, 'tannerh', 150),
(192, 'Turtle', 'Billy', 'M', 1954, 'tannerh', 148),
(193, 'Cow', 'Jimmy', 'M', 1987, 'tannerh', 141),
(194, 'Chicken', 'Harry', 'F', 1965, 'tannerh', 148),
(195, 'dog', 'Cache', 'M', 1901, 'tannerh', 150),
(196, 'fish', 'Toby', 'M', 2005, 'tannerh', 141),
(197, 'Dog', 'jack', 'm', 2017, 'zacharys', 154),
(198, 'Horse', 'betty', 'f', 2013, 'zacharys', 152),
(199, 'Horse', 'tom', 'm', 2012, 'zacharys', 157),
(200, 'Horse', 'Seabisket', 'f', 2016, 'zacharys', 155),
(201, 'Horse', 'Janet', 'f', 2017, 'zacharys', 158),
(202, 'Snake', 'Neginie', 'f', 2018, 'zacharys', 153),
(203, 'Snake', 'Snape', 'm', 2013, 'zacharys', 159),
(204, 'Dog', 'Buddy', 'm', 2016, 'zacharys', 154),
(205, 'Dog', 'Princess', 'f', 2017, 'zacharys', 160),
(206, 'Dog', 'Mary', 'f', 2015, 'zacharys', 156),
(207, 'Snake', 'Boa', 'm', 2019, 'zacharys', 154),
(208, 'Cat', 'gambler', 'f', 2016, 'zacharys', 151),
(209, 'cat', 'Whiskers', 'm', 2014, 'zacharys', 160),
(210, 'cat', 'spots', 'm', 2017, 'zacharys', 157),
(211, 'dog', 'Juanita', 'f', 2015, 'zacharys', 156);
...
--
ALTER TABLE `animal`
  MODIFY `IDanimal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=212;
--
